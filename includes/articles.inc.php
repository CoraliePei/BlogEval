...
// Partie affichage des articles publiés et brouillons pour les admins et rédacteurs
if (verifierAdmin() || verifierRedacteur()) {
    ...
    // Partie affichage de la liste des articles publiés uniquement pour les visiteurs, utilisateurs et modérateurs
} else {
    if (!empty($_GET['id_categorie']) && ctype_digit($_GET['id_categorie'])) {
        $id_categorie = $_GET['id_categorie'];
